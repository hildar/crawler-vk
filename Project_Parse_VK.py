# 1. Выберите тему для сбора данных, примеры:
# рынок недвижимости, рынок авто, рынок вакансий, госзакупки, ценные бумаги, облигации,
# фильмы (кинопоиск, imdb), биржи валют/криптовалют
# 2. Подумать, для какой цели из одного из источников вы могли бы собирать данные
# 3. Написать парсер, используя любую из изученных технологий.

# Тема: Парсер Вконтакте. Получение информации о постах и кому они понравились.
# Кодовое название: <<Big bro>>.
# Цель: Социальные исследования. Исследования трендов.
